	...
	var data = {
		...
		"ua": {
			...
			"professional_profile": {
				...
				".block_ptext": "Молодий та амбітний програміст з більш ніж 6 роками досвіду у розробці програмного забезпечення. Почав свій шлях у світі програмування у віці 14 років і з того часу успішно завершив 4 значні проекти. Спеціалізуюсь у веб- та backend-розробці, однак також маю інтерес та досвід у desktop та Android розробці як хобі."
			},
			"skills": {
				".skills_text": "Навички:",
